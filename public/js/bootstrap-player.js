	...
	$('audio[controls]').before(function(){
		...
		var addPlay = function() {
			var play = document.createElement('button');
				$(play).addClass('btn btn-lg btn-success disabled span1');
			...
			if($(song).attr('autoplay')=='autoplay'){
		...
		var addSeek = function(elWidth) {
			...
			var seek_wrapper = document.createElement('div');
				$(seek_wrapper).addClass('btn span4 progress-seek');

			if(elWidth){
				$(seek_wrapper).css('width', elWidth);
			}
		...
		var addVolume = function() {
			...
			var vol_wrapper = document.createElement('div');
				$(vol_wrapper).addClass('btn disabled span3 volume-btn');
		...
		var addPlayer = function() {
			...
			if ($(song).data('seek') !== 'off'){ addSeek($(song).data('seek-width'));}
